...
class MenuLevels(Form):
    def __init__(self, name, master_surface, pos, size, image_bg, color_bg, color_border, active):
        ...
        self.__image_header = py.transform.rotozoom(self.__image_header, 0, 0.6).convert_alpha()
        self.__rect_image_header = self.__image_header.get_rect(midtop=(W_MENU/2, -15))
