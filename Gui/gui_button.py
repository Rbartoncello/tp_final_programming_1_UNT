...
class Button(Widget):
    def __init__(self, master, pos, size, color_background=GREEN, color_border=RED1, image_background=None, text="Button", font="Arial", font_size=14, font_color=BLUE, on_click=None, on_click_param=None):
        super().__init__(master, pos, size, color_background, color_border, image_background, text, font, font_size, font_color)
