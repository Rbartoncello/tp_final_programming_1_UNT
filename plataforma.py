...
class Platform:
    def __init__(self, data):
        ...
        self.rects = {
            ...
            RIGHT: pygame.Rect(self.rect.right-W_H_RECT, self.rect.top + W_H_RECT+2, W_H_RECT, self.rect.h-2*W_H_RECT-5)
        }

    def draw(self, screen):
        screen.blit(self.image, self.rect)
        Auxiliar.debuggerMod(screen=screen, color_main=GRAY, color_top=GREEN, color_bottom=BLUE, color_left=YELLOW1, color_right=BROWN, rect_main=self.rect, rects=self.rects)
